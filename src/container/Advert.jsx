...
import portforlio1 from "../assets/img/portfolio/portfolio-1.jpg"
import portforlio2 from "../assets/img/portfolio/portfolio-2.jpg"
import portforlio3 from "../assets/img/portfolio/portfolio-3.jpg"
import portforlio4 from "../assets/img/portfolio/portfolio-4.jpg"
import portforlio5 from "../assets/img/portfolio/portfolio-5.jpg"
import portforlio6 from "../assets/img/portfolio/portfolio-6.jpg"
import portforlio7 from "../assets/img/portfolio/portfolio-7.jpg"
import portforlio8 from "../assets/img/portfolio/portfolio-8.jpg"
import portforlio9 from "../assets/img/portfolio/portfolio-9.jpg"
import "../main"
const Advert = () => {
  return (
        ...
        <div className="row gy-4 portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div className="col-lg-4 col-md-6 portfolio-item filter-app">
            <div className="portfolio-wrap">
              <img src={portforlio1} className="img-fluid" alt=""/>
          ...
          <div className="col-lg-4 col-md-6 portfolio-item filter-web">
            <div className="portfolio-wrap">
              <img src={portforlio2} className="img-fluid" alt=""/>
              <div className="portfolio-info">
                <h4>Web 3</h4>
                <p>Web</p>
                <div className="portfolio-links">
          ...
          <div className="col-lg-4 col-md-6 portfolio-item filter-app">
            <div className="portfolio-wrap">
              <img src={portforlio3} className="img-fluid" alt=""/>
              <div className="portfolio-info">
                <h4>App 2</h4>
                <p>App</p>
                <div className="portfolio-links">
          ...
          <div className="col-lg-4 col-md-6 portfolio-item filter-card">
            <div className="portfolio-wrap">
              <img src={portforlio4} className="img-fluid" alt=""/>
              <div className="portfolio-info">
                <h4>Card 2</h4>
                <p>Card</p>
                <div className="portfolio-links">
          ...
          <div className="col-lg-4 col-md-6 portfolio-item filter-web">
            <div className="portfolio-wrap">
              <img src={portforlio5} className="img-fluid" alt=""/>
              <div className="portfolio-info">
                <h4>Web 2</h4>
                <p>Web</p>
                <div className="portfolio-links">
          ...
          <div className="col-lg-4 col-md-6 portfolio-item filter-app">
            <div className="portfolio-wrap">
              <img src={portforlio6} className="img-fluid" alt=""/>
              <div className="portfolio-info">
                <h4>App 3</h4>
                <p>App</p>
                <div className="portfolio-links">
          ...
          <div className="col-lg-4 col-md-6 portfolio-item filter-card">
            <div className="portfolio-wrap">
              <img src={portforlio7} className="img-fluid" alt=""/>
              <div className="portfolio-info">
                <h4>Card 1</h4>
                <p>Card</p>
                <div className="portfolio-links">
          ...
          <div className="col-lg-4 col-md-6 portfolio-item filter-card">
            <div className="portfolio-wrap">
              <img src={portforlio8} className="img-fluid" alt=""/>
              <div className="portfolio-info">
                <h4>Card 3</h4>
                <p>Card</p>
                <div className="portfolio-links">
          ...
          <div className="col-lg-4 col-md-6 portfolio-item filter-web">
            <div className="portfolio-wrap">
              <img src={portforlio9} className="img-fluid" alt=""/>
              <div className="portfolio-info">
                <h4>Web 3</h4>
                <p>Web</p>
                <div className="portfolio-links">
